          ...
          <div id="bt_registros" class="col-3">
            <form action="form1" id="form1" name="form1" method="post" style="color:orangered; font-size:25px; font-weight: 40px;">
                <div class="form-group">
                  ...
                  <input type="submit" name="ingreso" value="Ingreso" class="btn bg-success text-white" onclick=this.form.action="../../Controlador/ValidarRegistro.php?btn=1">
                  <input type="submit" name="salida" value="Salida" class="btn bg-danger float-right text-white" onclick=this.form.action="../../Controlador/ValidarRegistro.php?btn=2" style="margin-top:05px;">
